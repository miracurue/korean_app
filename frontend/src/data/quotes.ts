...
export interface Quote {
  ...
  textRus: string;
  audioUrl?: string;
  bgImage?: string;    // Background image for the card
  source: string;
  likesCount: number;
  clonesCount: number;
  tags: string[];
...
export const MOCK_QUOTES: Quote[] = [
  {
    ...
    bgImage: '/pics/quotes/goblin.png',
  ...
  },
  {
    ...
    bgImage: '/pics/quotes/itaewon.png',
    source: 'Итэвон Класс',
    likesCount: 2105,
    clonesCount: 472,
  ...
  },
  {
    ...
    bgImage: '/pics/quotes/winter.png',
  ...
  },
  {
    ...
    bgImage: '/pics/quotes/alchemy.png',
    source: 'Алхимия душ',
    likesCount: 635,
    clonesCount: 89,
